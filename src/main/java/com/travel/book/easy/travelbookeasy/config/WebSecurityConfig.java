    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
            .authorizeRequests()
                ...
                .antMatchers("/users/enableUser/**").hasRole("ADMIN")
                .antMatchers("/users/accessTokenGD").hasAnyRole("ADMIN", "USER")
                .antMatchers("/users/**").hasRole("USER")
                .antMatchers("/booking/**").hasRole("USER")
                .antMatchers("/company/create/**").hasRole("ADMIN")
                .antMatchers("/company/uploadCompanyLogo/**").hasRole("ADMIN")
                .antMatchers("/company/updateCompany/**").hasRole("ADMIN")
                .antMatchers("/company/all").hasAnyRole("USER", "ADMIN")
