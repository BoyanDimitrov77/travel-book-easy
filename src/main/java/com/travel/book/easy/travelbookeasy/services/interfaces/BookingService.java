...
public interface BookingService {
	...
	TransportBookingDto<BusDto> payBookedBus(BigDecimal amount, long busBookId);
	...
	TransportBookingDto<TrainDto> payBookedTrain(BigDecimal amount, long trainBookId, long travelClassId);
}
